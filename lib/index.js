global.Sova = {
  ...
  createInstance: (className, ...arguments) => new className(...arguments),
  handlePromise: (...promiseAndHandlers) =>
    promiseAndHandlers.reduce((a, b) => a.then(b)),
  isFunctionWithoutArguments: value =>
